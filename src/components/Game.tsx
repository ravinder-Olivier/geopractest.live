...
export default function Game({ reSpin, setShowStats, setScreen, setNewGame, newGame }: Props) {
  ...
  const [inTheGame, setInTheGame] = useState(true)
  ...
  return (
    <Suspense fallback={renderLoader()}>
      ...
      {!reSpin && (
        <div>
          <Globe
            guesses={guesses} globeRef={globeRef} />
